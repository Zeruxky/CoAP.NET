namespace WorldDirect.CoAP.Specs
{
    ...
    {
        [Fact]
        public void UriPathOnlyAccepts255Bytes()
        {
            ...
            Assert.Throws<ArgumentOutOfRangeException>(() => new UriPath(bytes));
        }

        [Fact]
        public void UriHostNumberIs11()
        {
            UriPath.NUMBER.Should().Be(11);
        }
    }
}